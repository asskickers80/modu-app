...
export const test = base.extend({
  supabaseWriteGuard: [async ({ page }, use) => {
    ...
    for (const t of ['watchlist', 'watch_notifications', 'listing_owner_messages', 'inquiry_ledger', 'sales_card_impressions', 'reb_market_stats', 'listing_field_sources', 'demand_signals', 'demand_signal_targets', 'price_inquiry_feedback', 'reviews', 'review_appeals', 'listing_reveals', 'vendor_take_invites', 'vendor_takes', 'listing_ask_examples', 'listing_ask_cache', 'ask_question_events', 'ask_question_facts', 'vendor_subscriptions', 'saved_searches', 'search_demand_facts']) {
