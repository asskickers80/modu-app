  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      <header className="shrink-0 bg-white border-b border-gray-100">
        <div className="flex items-center gap-3 px-5 pt-12 pb-4">
          <div className="flex-1">
            ...
            {totalCount > 0 && (
              <p className="text-t12 mt-0.5" style={{ color: TEAL }}>문의 {totalCount}건</p>
            )}
          </div>
      ...
      <div className="shrink-0 mx-4 mt-3 mb-1 rounded-xl px-3.5 py-2.5 flex items-center gap-2"
        ...
        <p className="text-t11 font-medium" style={{ color: TEAL }}>
                ...
                return (
                  <button
                    ...
                    <div className="w-11 h-11 rounded-full flex items-center justify-center shrink-0 text-t15 font-bold text-white relative"
                      style={{ backgroundColor: exchanged ? '#16a34a' : TEAL }}>
                      {otherName[0]}
                    </div>
      ...
      <BottomNav active="message" accent={TEAL} homePath="/a7/landlord" />
    </div>
  )
}
