  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden">
      <header className="shrink-0 bg-white border-b border-gray-100">
        <div className="flex items-center gap-3 px-5 pt-12 pb-4">
          <div className="flex-1">
            ...
            {totalCount > 0 && (
              <p className="text-t12 mt-0.5" style={{ color: GREEN }}>문의 {totalCount}건</p>
            )}
          </div>
      ...
      <div className="shrink-0 mx-4 mt-3 mb-1 rounded-xl px-3.5 py-2.5 flex items-center gap-2"
        ...
        <p className="text-t11 font-medium" style={{ color: GREEN }}>
      ...
      <BottomNav active="message" accent={GREEN} homePath="/a7/operating" />
    </div>
  )
}
