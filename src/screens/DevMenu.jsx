...
const GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '마이 > 제안 받기 설정 (12개 분류 토글)', path: '/my/proposal-settings', dot: '#7d4ba3' },
      { name: '마이 > 멤버십·구독', path: '/my/membership' },
      { name: '마이 > 결제 수단', path: '/my/payment-method' },
      { name: '마이 > 결제 내역', path: '/my/payment-history' },
      { name: '마이 > FAQ', path: '/my/faq' },
      { name: '마이 > 공지사항', path: '/my/notice' },
      { name: '마이 > 실험실', path: '/my/lab' },
      { name: '마이 > 이용약관', path: '/my/terms' },
      { name: '마이 > 개인정보처리방침', path: '/my/privacy' },
      { name: '마이 > 사업자 인증', path: '/my/business-cert' },
      { name: '마이 > 본인인증', path: '/my/identity' },
      { name: '마이 > PIN·비밀번호', path: '/my/pin' },
      { name: '마이 > 로그인 기기 관리', path: '/my/devices' },
      { name: '마이 > 이름 변경', path: '/my/name' },
      { name: '마이 > 연락처', path: '/my/contact' },
      { name: '마이 > 사업자 정보', path: '/my/business-info' },
      { name: '마이 > 연결된 소셜 계정', path: '/my/social' },
    ],
  },
  {
    label: 'B2 · 탐색 · 커뮤니티',
