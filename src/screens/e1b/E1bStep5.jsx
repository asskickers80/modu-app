    ...
    <div className="h-screen flex flex-col overflow-hidden">
      <div className="shrink-0 bg-white">
        <div className="flex items-center px-5 pt-12 pb-2 gap-2">
          ...
          <span className="text-t13 font-bold" style={{ color: PURPLE }}>5 / 5</span>
        </div>
        <ProgressBar />
        <div className="px-5 pb-5 border-b border-gray-50">
          <h2 className="text-t20 font-bold text-gray-900">⑤ 견적·문의 설정</h2>
          <p className="text-t13 text-gray-400 mt-1">연락처 비공개 · DM으로만 문의받아요</p>
        </div>
      </div>
      ...
      <main className="flex-1 overflow-y-auto px-5 pt-5 pb-32" style={{ scrollbarWidth: 'none' }}>
        ...
        {/* 페이지 미리보기 */}
        <div className="mb-5">
          <p className="text-t12 font-bold text-gray-400 mb-2">노출 페이지 미리보기</p>
          <div className="rounded-2xl border-2 p-4 overflow-hidden"
              ...
              <div className="flex-1">
                ...
                <div className="flex gap-1.5 mt-1.5 flex-wrap">
                  {(data.triggers.slice(0, 2)).map(t => (
                    <span key={t} className="text-t9 px-2 py-0.5 rounded-full border"
            ...
            <div className="flex items-center justify-between pt-3 border-t border-gray-50">
              <div>
                <p className="text-t10 text-gray-400">응답 속도</p>
                <p className="text-t12 font-bold" style={{ color: PURPLE }}>
                  {SPEED_OPTS.find(s => s.id === speed)?.sub}
                </p>
              </div>
              <button className="px-4 py-2 rounded-xl text-t13 font-bold text-white"
        ...
        {/* 응답 속도 */}
        <div className="mb-5">
          <p className="text-t12 font-bold text-gray-400 mb-2">응답 속도</p>
          <div className="flex gap-2">
            {SPEED_OPTS.map(opt => (
              <button key={opt.id}
                ...
                <span className="text-t16">{opt.icon}</span>
                <p className="text-t12 font-bold" style={{ color: speed === opt.id ? PURPLE : '#374151' }}>
                  {opt.label}
                </p>
                <p className="text-t10" style={{ color: speed === opt.id ? PURPLE : '#9ca3af' }}>
                  {opt.sub}
                </p>
              </button>
            ))}
        ...
        <div className="mb-5">
          <div className="flex items-center justify-between px-4 py-3.5 rounded-2xl border"
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-t13 font-semibold text-gray-800">예약금 받기</p>
                <p className="text-t11 text-gray-400">노쇼 방지 · 금액 직접 협의</p>
              </div>
            </div>
        ...
        <div className="mb-5">
          <div className="flex items-center justify-between px-4 py-3.5 rounded-2xl border"
            ...
            <div className="flex items-center gap-2.5">
              <span className="text-t18">💬</span>
              <div>
                <p className="text-t13 font-semibold text-gray-800">DM 문의 수신 활성화</p>
                <p className="text-t11 text-gray-400">OFF 시 문의를 받지 않아요</p>
              </div>
            </div>
        ...
        <div className="rounded-2xl bg-gray-50 px-4 py-3 text-t12 text-gray-400 leading-relaxed">
      ...
      <div className="shrink-0 px-5 py-4 bg-white border-t border-gray-50">
        <button onClick={handlePublish}
          className="w-full py-[18px] rounded-2xl text-t16 font-bold text-white transition-all"
          style={{ backgroundColor: PURPLE }}>
          노출 시작하기
        </button>
        <p className="text-center text-t11 text-gray-300 mt-2">언제든 비공개로 전환 가능해요</p>
      </div>
          ...
          <div className="w-full bg-white rounded-3xl p-6 text-center">
            {done ? (
              <>
                ...
                <p className="text-t18 font-black text-gray-900">노출이 시작됐어요!</p>
                <p className="text-t13 text-gray-400 mt-1">대시보드로 이동 중...</p>
              </>
            ) : (
              <>
                <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"
                ...
                <p className="text-t18 font-black text-gray-900">이제 자영업자에게<br />노출돼요</p>
                <p className="text-t13 text-gray-500 mt-2 mb-5 leading-relaxed">
