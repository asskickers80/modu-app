  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center"
      ...
      <button
        ...
        className="w-full max-w-[320px] py-[16px] rounded-2xl text-t16 font-bold text-white mb-3 active:scale-[0.98] transition-transform"
      ...
      <button
        ...
        className="text-t14 font-medium text-gray-400 underline underline-offset-2">
        회원가입하고 시작하기
      </button>
    </div>
  )
