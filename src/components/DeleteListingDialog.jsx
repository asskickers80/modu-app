  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-6" data-testid="delete-confirm">
      ...
      <div className="relative w-full max-w-[340px] bg-white rounded-3xl p-6 text-center">
        ...
        <p className="text-t17 font-bold text-gray-900 mt-2 mb-1">{noun} 내리기 — 정말 내릴까요?</p>
        ...
        <button onClick={onConfirm} data-testid="delete-confirm-yes"
          className="w-full py-[14px] rounded-2xl text-t15 font-bold text-white mb-2" style={{ backgroundColor: '#ef4444' }}>
          내리기 (삭제)
        </button>
        <button onClick={onCancel}
          className="w-full py-[12px] rounded-2xl text-t14 font-medium text-gray-400">
          취소
        </button>
      </div>
    </div>
