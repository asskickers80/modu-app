...
### 다음 할 일
- 업종 분류 통일 1단계 — **대표님 판단 4건 대기** (0단계 조사 완료: docs/BIZTYPE-UNIFY-STEP0.md, SQL: scripts/sql/20260720-biztype-unify.sql). 판단 필요: ①매핑 불가 7종(안경 소분류 신설? 점포 아닌 인력파견·운송·이사 취급?) ②평면 12종 병합 8건 재질문 여부 ③E1 업종 UI 형태(2단계 드릴다운 vs 검색) ④완성도 점수에 업종 편입 여부. 판단 후: SQL 실행 → E1 입력·저장 → 표시·필터 순
