...
### 다음 할 일
- 업종 표기 일원화: E1 업종은 평면 12종(E1Step1 BIZ_TYPE_OPTS), A3 온보딩은 categories.ts 2단계(category_main/sub)로 서로 다른 체계. 프랜차이즈 매물만 DB franchise_brands.biz_type의 "대분류 > 소분류" 형태가 들어와 표기가 섞임 — 체계 통일 필요 (스키마 판단 필요, 대표님 결정 대기)
