...
- 매물 사진 정책: 내부 3장 필수(3단계 진행 차단)·합산 5장 상한(등급 config lib/memberTier.js — 프리미엄 15장 예약)·외부 사진 신상 노출 안내·품질 규정 안내. 가이드 "내부 사진 3장 올리기"(내부 기준 판정). 스키마 변경 불필요(기존 interior/exterior_image_urls 컬럼 사용). Playwright 167개.
